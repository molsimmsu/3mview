 ...
 *	$Revision: 1.170 $	$Date: 2011/12/03 20:02:56 $
 *
 ***************************************************************************
 * DESCRIPTION:
 *
...
private:
  ...
  QuickSurf qsurf;             ///< QuickSurf object
  ...
  void draw_volume_field_lines(int volid, float seedval, float minlen, float maxlen, float thickness); ///< Volume gradient field lines
  ...
  int calcseeds_gradient_magnitude(const VolumetricData *v, ResizeArray<float> *seeds, float seedmin, float seedmax);
