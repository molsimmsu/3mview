...
Ubuntu:
    ...
    sudo apt-get install libspnav-dev libqt4-dev cmake libeigen2-dev libboost-all-dev libpng12-dev libfftw3-dev libtiff5-dev python-sip-dev python-qt4-dev libdevil-dev libglew-dev
