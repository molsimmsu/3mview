...
#ifndef VRN_VOLUMECOLLECTIONRAYCASTER_H
#define VRN_VOLUMECOLLECTIONRAYCASTER_H
 ...
 */
class VolumeCollectionRaycaster : public VolumeRaycaster {
public:
    VolumeCollectionRaycaster();
    Processor* create() const;

    std::string getClassName() const    { return "VolumeCollectionRaycaster"; }
...
#endif // VRN_VOLUMECOLLECTIONRAYCASTER_H
