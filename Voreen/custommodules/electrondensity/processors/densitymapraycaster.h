...
#ifndef VRN_DENSITYMAPRAYCASTER_H
#define VRN_DENSITYMAPRAYCASTER_H

#include "../datastructures/moleculevolume.h" // XXX
 ...
 */
class DensityMapRaycaster : public VolumeRaycaster {
public:
    DensityMapRaycaster();
    virtual Processor* create() const;

    virtual std::string getClassName() const    { return "DensityMapRaycaster"; }
