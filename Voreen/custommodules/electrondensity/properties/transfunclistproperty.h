...
#ifndef VRN_TRANSFUNCLISTPROPERTY_H
#define VRN_TRANSFUNCLISTPROPERTY_H
 ...
 */
class VRN_CORE_API TransFuncListProperty : public TemplateProperty<std::vector<std::string> > {
public:
    /**
     * Constructor.
     *
     ...
     */
    TransFuncListProperty(const std::string& id, const std::string& guiText, const std::vector<std::string>& value, bool isLoadable = false,
        int invalidationLevel = Processor::INVALID_PARAMETERS);
    TransFuncListProperty();

    virtual Property* create() const;

    virtual std::string getClassName() const       { return "TransFuncListProperty"; }
