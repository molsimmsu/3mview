...
#ifndef VRN_STEREOCAMERAINTERACTIONHANDLER_H
#define VRN_STEREOCAMERAINTERACTIONHANDLER_H
 ...
 */
class VRN_CORE_API StereoCameraInteractionHandler : public InteractionHandler {

    friend class EventProperty<StereoCameraInteractionHandler>;
...
public:
    ...
    StereoCameraInteractionHandler();
     ...
     */
    StereoCameraInteractionHandler(const std::string& id, const std::string& guiText, CameraProperty* cameraProp,
    CameraProperty* cameraPropLeft, CameraProperty* cameraPropRight,
    FloatProperty* eyeSeparation, FloatProperty* cameraDistance, bool sharing = false, bool enabled = true);

    virtual ~StereoCameraInteractionHandler();
...
private:
    ...
    CameraProperty* cameraPropLeft_;
    CameraProperty* cameraPropRight_;
    
    FloatProperty* eyeSeparation_;
    FloatProperty* cameraDistance_;
    ...
    EventProperty<StereoCameraInteractionHandler>* rotateEvent_;
    EventProperty<StereoCameraInteractionHandler>* zoomEvent_;
    EventProperty<StereoCameraInteractionHandler>* shiftEvent_;
    EventProperty<StereoCameraInteractionHandler>* wheelZoomEvent_;

    // first-person properties
    EventProperty<StereoCameraInteractionHandler>* moveForwardEvent_;
    EventProperty<StereoCameraInteractionHandler>* moveLeftEvent_;
    EventProperty<StereoCameraInteractionHandler>* moveBackwardEvent_;
    EventProperty<StereoCameraInteractionHandler>* moveRightEvent_;
    EventProperty<StereoCameraInteractionHandler>* moveUpEvent_;
    EventProperty<StereoCameraInteractionHandler>* moveDownEvent_;
...
#endif // VRN_STEREOCAMERAINTERACTIONHANDLER_H
