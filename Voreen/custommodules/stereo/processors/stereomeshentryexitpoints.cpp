...
#include "stereomeshentryexitpoints.h"

#include "../interaction/stereocamerainteractionhandler.h"
...
const std::string StereoMeshEntryExitPoints::loggerCat_("voreen.StereoMeshEntryExitPoints");
...
Processor* StereoMeshEntryExitPoints::create() const {
    return new StereoMeshEntryExitPoints();
}

void StereoMeshEntryExitPoints::initialize() throw (tgt::Exception) {
...
void StereoMeshEntryExitPoints::deinitialize() throw (tgt::Exception) {
...
bool StereoMeshEntryExitPoints::isReady() const {
...
void StereoMeshEntryExitPoints::beforeProcess() {
...
void StereoMeshEntryExitPoints::onJitterEntryPointsChanged() {
