...
#ifndef VRN_SEGMENTATIONBASE_H
#define VRN_SEGMENTATIONBASE_H
 ...
 */
class SegmentationBase : public CachingVolumeProcessor {
public:
    SegmentationBase();
    virtual ~SegmentationBase();
    virtual Processor* create() const;

    virtual std::string getClassName() const { return "SegmentationBase";       }
